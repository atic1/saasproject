  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 p-4">
      <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 max-w-md w-full text-center shadow-xl border border-gray-100 dark:border-gray-800 animate-slide-up">
        <div className="h-20 w-20 bg-yellow-50 dark:bg-yellow-950/30 rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
          Your payment transaction is processing. eSewa status verification check was initiated and we are waiting for confirmation.
        </p>
